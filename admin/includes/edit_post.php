...
<form action="" method="post" enctype="multipart/form-data">    
     ...
     <div class="form-group">
      <label for="post_catego ry">Post Categories</label><br>
    ...
    <!-- <div class="form-group">
        ...
        <input value =  "<?php echo $post_status; ?>" class="form-control" name="post_status" id="">
     </div> -->
    ...
    <div class="form-group">
        <input class="btn btn-primary" class="form-control" type="submit" name="update_post" value="update post">
    </div>
</form>