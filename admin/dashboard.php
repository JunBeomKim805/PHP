                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Welcome to Admin dashboard <?php echo $_SESSION['user_name']?>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                        ...
                        function drawChart() {
                            ...
                            ['Data', 'Count'],
                                <?php 
                                    ...
                                    $element_count = [$post_counts, $post_publish_counts ,$post_draft_counts , $comments_counts,$unapproved_comments_count, $users_counts, $subscriber_count ,$categories_counts];
