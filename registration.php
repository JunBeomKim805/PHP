                ...
                <h1><?php echo _REGISTER ?></h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_name" id="user_name"  value="<?php echo isset($username) ? $username : '' ?>" autocomplete="on" class="form-control" placeholder="<?php echo _USERNAME ?>">
                            <p><?php echo isset($error['user_name']) ? $error['user_name'] : '' ?></p>
                        </div>
                         <div class="form-group">
                            <label for="email" class="sr-only">Email</label>
                            <input type="email" value="<?php echo isset($email) ? $email : '' ?>" autocomplete="on" name="email" id="email" class="form-control" placeholder="<?php echo _EMAIL ?>">
